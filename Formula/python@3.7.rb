class PythonAT37 < Formula
  ...
  bottle do
    root_url "https://github.com/sashkab/homebrew-python/releases/download/python@3.7-3.7.12"
    sha256 catalina: "e1d2f2aa9b2b4f25f0a921f4b36c4e5240b45c0c9baea1cad6dfbba120bfba00"
  end
  ...
  resource "setuptools" do
    url "https://pypi.org/packages/source/s/setuptools/setuptools-60.10.0.tar.gz"
    sha256 "6599055eeb23bfef457d5605d33a4d68804266e6cb430b0fb12417c5efeae36c"
  end

  resource "pip" do
    url "https://www.pypi.org/packages/source/p/pip/pip-22.0.4.tar.gz"
  ...
  def caveats
    ...
    <<~EOS
      ...
      You can install Python packages with
        #{opt_bin}/pip3.7 install <package>
